    ...
    <div className="glass-panel rounded-2xl p-6 lg:p-8 relative overflow-hidden border border-slate-800">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="p-3.5 rounded-xl bg-purple-950/20 border border-purple-800/30 text-xs text-purple-200/90 flex items-start gap-2.5">
          <svg width={16} height={16} className="w-4 h-4 text-purple-400 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        >
          {isSubmitting ? (
            <>
              <svg width={16} height={16} className="w-4 h-4 animate-spin text-purple-300" fill="none" viewBox="0 0 24 24">
      ...
      {errorMessage && (
        <div className="mt-4 p-4 rounded-xl bg-rose-950/60 border border-rose-800 text-rose-200 text-xs flex items-center gap-3">
          <svg width={20} height={20} className="w-5 h-5 text-rose-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {receipt && (
        <div className="mt-6 p-4 rounded-xl bg-emerald-950/50 border border-emerald-700/60 text-emerald-200 text-xs space-y-2">
          <div className="flex items-center gap-2 font-bold text-emerald-300 text-sm">
            <svg width={20} height={20} className="w-5 h-5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
