/**
 * End-to-end smoke check for anonymous-mental-health-survey.
 *
...
async function main() {
  ...
  console.log(`   isSurveyActive:   ${ledgerState.isSurveyActive}`);
  console.log(`   totalSubmissions: ${ledgerState.totalSubmissions}`);
